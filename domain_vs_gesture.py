...
if __name__ == '__main__':
    ...
    for gesture in gestureList:
        analysisCount[gesture] = dict()
        
        for domainName in domainList:
            analysisCount[gesture][domainName] = 0
    ...
    print '\t'.join(['domain'] + domainList)
    for gesture in gestureList:
        printList = [str(analysisCount[gesture][domain]) for domain in domainList]
        print '\t'.join([gesture] + printList)
